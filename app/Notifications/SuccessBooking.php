...
class SuccessBooking extends Notification implements ShouldQueue
{
    use Queueable;
    public $booking_id;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->line('We are pleased to confirm your booking. Click th link below to view details of your reservation:')
