...
class SuccessCheckIn extends Notification implements ShouldQueue
{
    use Queueable;
    public $booking_id;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->line('Your reservation is successfully checked in. Click the link below to view details the details:')
